...
// Removed TypeScript interfaces, using plain JS objects and arrays
...
export function DietCycleTab() {
  ...
  const removeItem = (cycleId, itemId) => {
    setCycles(
      cycles.map((cycle) =>
        cycle.id === cycleId
          ? {
