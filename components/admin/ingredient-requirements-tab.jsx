...
// Removed TypeScript interfaces. All data/state is pure JS objects/arrays.
...
export function IngredientRequirementsTab() {
  ...
  const removeDietType = (id) => {
    setDietTypes(dietTypes.filter((d) => d.id !== id))
  }

  const addIngredient = (dietId) => {
    setDietTypes(
      dietTypes.map((diet) =>
        diet.id === dietId
          ? {
  ...
  const removeIngredient = (dietId, index) => {
    setDietTypes(
      dietTypes.map((diet) =>
        diet.id === dietId
          ? {
  ...
  const updateIngredient = (dietId, index, field, value) => {
    setDietTypes(
      dietTypes.map((diet) =>
        diet.id === dietId
          ? {
