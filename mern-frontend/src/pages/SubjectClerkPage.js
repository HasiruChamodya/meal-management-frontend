  ...
  return (
    <div className="min-h-screen bg-background p-6 md:p-12">
      <div className="mx-auto max-w-7xl">
        ...
        <h1 className="text-4xl font-bold text-foreground mb-2">Subject Clerk Dashboard</h1>
        <p className="text-lg text-muted-foreground">Manage pricing and purchase orders - Coming soon...</p>
      </div>
    </div>
  );
}
